            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h1><span class="turquoise">O'zbekistondagi Birinchi</span> Mega Online Do'kon</h1>
                        ...
                        <a class="btn-solid-lg page-scroll" href="<?= seller_url('account/register'); ?>">Do'kon ochish</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/header-teamwork.svg" alt="alternative">
                    ...
                    <div class="swiper-container image-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-1.png" alt="alternative">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-2.png" alt="alternative">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-3.png" alt="alternative">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-4.png" alt="alternative">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-5.png" alt="alternative">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image-container">
                                    <img class="img-responsive" src="<?= $this->getAssetsUrl(); ?>images/customer-logo-6.png" alt="alternative">
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- Card -->
                <div class="card">
                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/services-icon-1.svg" alt="alternative">
                    <div class="card-body">
                ...
                <!-- Card -->
                <div class="card">
                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/services-icon-2.svg" alt="alternative">
                    <div class="card-body">
                ...
                <!-- Card -->
                <div class="card">
                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/services-icon-3.svg" alt="alternative">
                    <div class="card-body">
...
<div class="basic-1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/details-1-office-worker.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
...
<div class="basic-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/details-2-office-team-work.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-6">
                <div class="text-container">
...
<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/details-lightbox-1.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-4">
...
<div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/details-lightbox-2.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-4">
                ...
                <div class="image-container">
                    <div class="video-wrapper">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                            <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/video-frame.svg" alt="alternative">
...
<div class="slider-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="<?= $this->getAssetsUrl(); ?>images/testimonials-2-men-talking.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-6">
                <h2>Testimonials</h2>
                ...
                <div class="slider-container">
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/testimonial-1.svg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/testimonial-2.svg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?= $this->getAssetsUrl(); ?>images/testimonial-3.svg" alt="alternative">
                                    <div class="card-body">
