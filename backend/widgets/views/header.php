...
$profile = Container::get('current_user_profile'); ?>
    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?= $app->homeUrl; ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= $this->imagesUrl('images/logo-sm-dark.png') ?>" alt="" height="30">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= $this->imagesUrl('images/logo-dark.png') ?>" alt="" height="35">
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="d-inline-block">
                <a href="<?= store_url(); ?>" class="btn header-item header-item-icon waves-effect" target="_blank">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0" aria-labelledby="page-header-notifications-dropdown">
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="<?= Url::to(['/profile/notifications']); ?>" class="small"> View All</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2 border-top">
                        <a class="btn btn-sm btn-link font-size-14 btn-block text-center" href="<?= Url::to(['/profile/notifications']); ?>">
