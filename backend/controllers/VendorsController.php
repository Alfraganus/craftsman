...
class VendorsController extends BackendController
{
    ...
    public function actionIndex()
    {
        ...
        $shops_url = Url::to([$this->shops_url]);
        $bulk_actions = array('activate', 'block', 'trash');

        $where_query = ['users.deleted' => 0];
        $query = Vendors::getItems()->andWhere($where_query);
        $count = $query->count();
        ...
        $page_types = Vendors::getPageTypes('');
    ...
    public function actionActive()
    {
        ...
        $page_types = Vendors::getPageTypes('active');
    ...
    public function actionPending()
    {
        ...
        $page_types = Vendors::getPageTypes('pending');
    ...
    public function actionBlocked()
    {
        ...
        $page_types = Vendors::getPageTypes('blocked');
    ...
    public function actionDeleted()
    {
        ...
        $page_types = Vendors::getPageTypes('deleted');
    ...
    public function actionCreate()
    {
        ...
        if ($post_item) {
            ...
            if ($submit_button == 'create_and_add_new' && $model->load($post_item) && $profile->load($post_item)) {
                ...
                Yii::$app->session->setFlash('success-alert', "The vendor was created successfully!");
    ...
    public function actionEdit($id)
    {
        ...
        if ($post_item) {
            ...
            if ($submit_button == 'create_and_add_new' && $model->load($post_item) && $profile->load($post_item)) {
                ...
                Yii::$app->session->setFlash('success-alert', "The vendor has been successfully updated!");
                return $this->redirect(['create']);
            } elseif ($model->load($post_item) && $profile->load($post_item)) {
                $model->updateUser($model, $profile, $post_item);
    ...
    public function actionJson()
    {
        ...
        if ($type == 'search') {
            ...
            $vendors = Vendors::search($keyword);
