                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <nav class="nav products-table-nav">
                                        <li class="text-secondary">Products: <?= count_segment_childs($one, 'products_count'); ?></li>
                                ...
                                <td class="ta-icons-block">
                                    <div class="ta-icons-in">
                                        <a href="<?= $main_url; ?>/create?parent=<?= $one->id ?>">
                                            <i class="ri-add-circle-line" data-toggle="tooltip" data-placement="top" title="Add child category"></i>
                                        </a>
                                    </div>
                                    <div class="ta-icons-in">
                                        <a href="<?= Url::current(['parent' => $one->id]); ?>">
                                            <i class="ri-list-unordered" data-toggle="tooltip" data-placement="top" title="Child categories"></i>
                                        </a>
                                    </div>
                                    <div class="ta-icons-in">
                                        <a href="#">
