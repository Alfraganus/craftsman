            ...
            <table class="table mb-0">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th>Fullname</th>
                        <th width="200px">Register date</th>
                        ...
                        <?php foreach ($shops as $shop) : ?>
                            ...
                            <tr>
                                <td class="ta-select-icon">
                                    <i class="ri-checkbox-blank-line" data-ta-select="<?= $shop->id ?>"></i>
                                </td>
                                <td>
                                    <a href="<?= $main_url; ?>/edit/<?= $shop->id ?>" class="products-table-title " title="<?= $shop->title ?>">
                                        <?= $shop->title ? $shop->title : '-'; ?>
                                    </a>
                                    <nav class="nav products-table-nav">
                                        <li class="text-secondary">
                                            Orders: <?= Shop::countShopOrders($shop->id); ?>
                                        </li>
                                        <li class="text-secondary">
                                            Products: <?= Shop::countShopProducts($shop->id); ?>
                                        </li>
                                        <li class="text-secondary">
                                            Users: <?= Shop::countShopUsers($shop->id); ?>
                                        </li>
                                    </nav>
                                </td>
                                <td><?= date('d/m/Y H:i', $shop->created_on); ?></td>
                                ...
                                <td class="ta-icons-block">
                                    ...
                                    <?php if ($shop->deleted) : ?>
                                        <div class="ta-icons-in">
                                            <a href="javascript:void(0);" ta-single-action="restore" ta-single-id="<?= $shop->id ?>">
                                                <i class="ri-refresh-line" data-toggle="tooltip" data-placement="top" title="Restore"></i>
                                            </a>
                                        </div>
                                        <div class="ta-icons-in">
                                            <a href="javascript:void(0);" ta-single-action="delete" ta-single-id="<?= $shop->id ?>">
                                                <i class="ri-delete-bin-2-line" data-toggle="tooltip" data-placement="top" title="Delete permanenty"></i>
                                            </a>
                                        </div>
                                    <?php else : ?>
                                        <div class="ta-icons-in">
                                            <a href="javascript:void(0);" ta-single-action="trash" ta-single-id="<?= $shop->id ?>">
