                    ...
                    <div class="card-body">
                        <div class="form-group required-field">
                            <?= html_entity_decode($form->field($model, 'parent_id')->dropDownList(
                                Segment::getListParent($model, $info),
                                [
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group position-relative">
                    <?= $form->field($info, 'icon', ['template' => media_browser_input('image')])
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <?= $form->field($model, 'posts_column')->dropDownList(
                            posts_column_types(),
                    ...
                    <div class="col-md-6 form-group">
                        <?= $form->field($model, 'posts_sorting')->dropDownList(
                            posts_sorting(),
                            ['class' => 'form-control custom-select']
                        ) ?>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        <?= $form->field($model, 'posts_per_page')->textInput(['type' => 'number']) ?>
                    </div>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="d-inline-block custom-control custom-checkbox mr-2">
                            ...
                            $checkbox_template .= '<label class="custom-control-label" for="segment-searchable">Searchable</label>';
                        ...
                        <div class="d-inline-block custom-control custom-checkbox mr-2">
                            <?php
                            $checkbox_template = '{input}';
                            $checkbox_template .= '<label class="custom-control-label" for="segment-cacheable">Cacheable</label>';
                            $checkbox_attrs = ['class' => 'custom-control-input', 'type' => 'checkbox', 'value' => 1];
                        ...
                        <div class="d-inline-block custom-control custom-checkbox mr-2">
                            <?php
                            $checkbox_template = '{input}';
                            $checkbox_template .= '<label class="custom-control-label" for="segment-deleted">Deleted</label>';
                            $checkbox_attrs = ['class' => 'custom-control-input', 'type' => 'checkbox', 'value' => 1];
