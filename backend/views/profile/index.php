...
$this->title = Yii::t('app', 'Profile: {email}', [
    'email' => $user->username,
]);

$this->breadcrumb_title = 'Profile';
                        ...
                        <div class="card-body text-center">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <a href="<?= Url::to(['/profile/settings']); ?>">Edit profile</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="<?= Url::to(['/profile/password']); ?>">Change password</a>
                                </li>
                                <li class="list-group-item">
