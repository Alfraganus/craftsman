                ...
                <div class="btn-group col-in">
                    <div class="dropdown lang-top-group-dropdown d-none d-sm-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="<?= Url::current(['lng' => null]); ?>" class="dropdown-item notify-item">
                                <i class="ri-earth-line"></i>
                                <span class="align-middle">Global</span>
                            </a>
                            <?php foreach ($languages as $language) : ?>
                                <a href="<?= Url::current(['lng' => $language['lang_code']]); ?>" class="dropdown-item notify-item">
