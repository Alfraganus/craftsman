                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="mt-4 mt-sm-0">
                            <p class="mb-2 text-muted text-truncate"><i class="mdi mdi-circle text-primary font-size-10 mr-1"></i> This
                                Year :</p>
                            <div class="d-inline-flex">
                            ...
                            <tbody>
                                    ...
                                    <td style="width: 60px;">
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="<?= $this->imagesUrl('images/companies/img-1.png') ?>" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="<?= $this->imagesUrl('images/companies/img-2.png') ?>" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="<?= $this->imagesUrl('images/companies/img-3.png') ?>" alt="" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                ...
                <div data-simplebar style="max-height: 330px;">
                    <ul class="list-unstyled activity-wid">
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">28 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">21 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">17 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">11 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">07 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">05 Apr, 2020
                        ...
                        <li class="activity-list">
                            ...
                            <div>
                                <div>
                                    <h5 class="font-size-13">02 Apr, 2020
                                        <small class="text-muted">12:07 am</small>
                                    </h5>
                                </div>
                            ...
                            <li>
                                <div class="conversation-list">
                                    <div class="chat-avatar">
                                        <img src="<?= $this->imagesUrl('images/users/avatar-2.jpg') ?>" alt="">
                                    </div>
