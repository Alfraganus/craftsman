                        ...
                        <div class="col-lg-9">
                            <div>
                                <div class="text-center">
                                    ...
                                    <h4 class="font-size-18 mt-4">Request password reset</h4>
                                ...
                                <div class="mt-5 text-center">
                                    <p>Don't have an account ? <a href="<?= \yii\helpers\Url::to('/auth/login') ?>" class="font-weight-medium text-primary"> Log in </a>
                                    </p>
                                </div>
                            </div>
